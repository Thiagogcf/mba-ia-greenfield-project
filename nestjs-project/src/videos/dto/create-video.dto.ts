...
export class CreateVideoDto {
  @ApiProperty({ maxLength: 255, example: 'My first video' })
  @IsString()
  @IsNotEmpty()
  @MaxLength(255)
  title: string;
  ...
  @ApiProperty({ maxLength: 255, example: 'my-video.mp4' })
  @IsString()
  @MaxLength(255)
  ...
  @ApiProperty({
    description: 'File size in bytes (max 10 GiB)',
    minimum: 1,
    maximum: VIDEO_MAX_FILE_SIZE_BYTES,
    example: 1048576,
  })
  @Type(() => Number)
  @IsInt()
  ...
  @ApiProperty({ enum: VIDEO_ALLOWED_CONTENT_TYPES, example: 'video/mp4' })
