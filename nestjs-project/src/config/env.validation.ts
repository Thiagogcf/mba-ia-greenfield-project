...
export const envValidationSchema = Joi.object({
  ...
  UPLOAD_PART_SIZE: Joi.number().integer().min(5242880).default(104857600),
  UPLOAD_MAX_FILE_SIZE: Joi.number().integer().default(10737418240),
  PRESIGN_PART_TTL: Joi.number().integer().default(3600),
  PRESIGN_STREAM_TTL: Joi.number().integer().default(21600),
  PRESIGN_DOWNLOAD_TTL: Joi.number().integer().default(900),
